...
OutFile "PlatyCanvas 1.6.3d.exe"
...
Section "MainSection" SEC01
  ...
  File "bin_Debug\vccorlib120d.dll"
  File "bin_Debug\Qt5Widgetsd.dll"
  File "bin_Debug\Qt5Widgetsd.pdb"
  File "bin_Debug\Qt5OpenGLd.dll"
  File "bin_Debug\Qt5OpenGLd.pdb"
  File "bin_Debug\Qt5Networkd.dll"
  File "bin_Debug\Qt5Networkd.pdb"
  File "bin_Debug\Qt5Guid.dll"
  File "bin_Debug\Qt5Guid.pdb"
  File "bin_Debug\Qt5Cored.dll"
  File "bin_Debug\Qt5Cored.pdb"
  File "bin_Debug\Qt5Bluetoothd.dll"
  File "bin_Debug\Qt5Bluetoothd.pdb"
  File "bin_Debug\platycanvas.exe"
  File "bin_Debug\platycanvas.pdb"
  File "bin_Debug\msvcr120d.dll"
  File "bin_Debug\msvcp120d.dll"
  File "bin_Debug\icuuc53.dll"
  File "bin_Debug\icuin53.dll"
  File "bin_Debug\icudt53.dll"
  SetOutPath "$INSTDIR\bin\platforms"
  File "bin_Debug\platforms\qwindowsd.dll"
  File "bin_Debug\platforms\qwindowsd.pdb"
  File "bin_Debug\platforms\qoffscreend.dll"
  File "bin_Debug\platforms\qoffscreend.pdb"
  File "bin_Debug\platforms\qminimald.dll"
  File "bin_Debug\platforms\qminimald.pdb"
...
Section Uninstall
  ...
  Delete "$INSTDIR\bin\platforms\qminimald.pdb"
  Delete "$INSTDIR\bin\platforms\qoffscreend.dll"
  Delete "$INSTDIR\bin\platforms\qoffscreend.pdb"
  Delete "$INSTDIR\bin\platforms\qwindowsd.dll"
  Delete "$INSTDIR\bin\platforms\qwindowsd.pdb"
  Delete "$INSTDIR\bin\icudt53.dll"
  Delete "$INSTDIR\bin\icuin53.dll"
  Delete "$INSTDIR\bin\icuuc53.dll"
  Delete "$INSTDIR\bin\msvcp120d.dll"
  Delete "$INSTDIR\bin\msvcp120d.pdb"
  Delete "$INSTDIR\bin\msvcr120d.dll"
  Delete "$INSTDIR\bin\msvcr120d.pdb"
  Delete "$INSTDIR\bin\platycanvas.exe"
  Delete "$INSTDIR\bin\platycanvas.pdb"
  Delete "$INSTDIR\bin\Qt5Bluetoothd.dll"
  Delete "$INSTDIR\bin\Qt5Bluetoothd.pdb"
  Delete "$INSTDIR\bin\Qt5Cored.dll"
  Delete "$INSTDIR\bin\Qt5Cored.pdb"
  Delete "$INSTDIR\bin\Qt5Guid.dll"
  Delete "$INSTDIR\bin\Qt5Guid.pdb"
  Delete "$INSTDIR\bin\Qt5Networkd.dll"
  Delete "$INSTDIR\bin\Qt5Networkd.pdb"
  Delete "$INSTDIR\bin\Qt5OpenGLd.dll"
  Delete "$INSTDIR\bin\Qt5OpenGLd.pdb"
  Delete "$INSTDIR\bin\Qt5Widgetsd.dll"
  Delete "$INSTDIR\bin\Qt5Widgetsd.pdb"
  Delete "$INSTDIR\bin\vccorlib120d.dll"
  Delete "$INSTDIR\bin\vccorlib120d.pdb"
